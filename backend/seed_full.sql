...
INSERT INTO users (id, phone, email, name, password_hash, role, avatar_url, referral_code, referred_by, is_active, created_at, updated_at) VALUES
(1,  '+60123456789', 'admin@loyaltysystem.uk',  'Admin User',       '$2b$12$.vuUeOcljqTq42tH9L2HsO5.EA0ue32xKs/a2ifdkfF8j9/sPHuLK', 'admin',       NULL, NULL,                          NULL,    TRUE, NOW() - interval '90 days', NOW()),
(2,  '+60177889900', 'ahmad.taher@email.my',    'Ahmad Taher',      '$2b$12$dummyhash1', 'customer',     NULL, 'REF-AHMAD01',                  NULL,    TRUE, NOW() - interval '60 days', NOW()),
(3,  '+60199887766', 'sarah.wong@email.my',     'Sarah Wong',       '$2b$12$dummyhash2', 'customer',     NULL, 'REF-SARAH02',                  NULL,    TRUE, NOW() - interval '55 days', NOW()),
(4,  '+60155667788', 'raj.kumar@email.my',      'Raj Kumar',        '$2b$12$dummyhash3', 'customer',     NULL, 'REF-RAJ03',                    NULL,    TRUE, NOW() - interval '50 days', NOW()),
(5,  '+60133445566', 'mei.lim@email.my',        'Mei Lim',          '$2b$12$dummyhash4', 'customer',     NULL, 'REF-MEI04',                    NULL,    TRUE, NOW() - interval '45 days', NOW()),
(6,  '+60112233445', 'aida.rahman@email.my',    'Aida Rahman',      '$2b$12$dummyhash5', 'customer',     NULL, 'REF-AIDA05',                   2,       TRUE, NOW() - interval '30 days', NOW()),
(7,  '+60188990011', 'store.owner@zus.my',      'ZUS Store Owner',  '$2b$12$.vuUeOcljqTq42tH9L2HsO5.EA0ue32xKs/a2ifdkfF8j9/sPHuLK', 'store_owner', NULL, NULL,                          NULL,    TRUE, NOW() - interval '85 days', NOW());
...
INSERT INTO store_tables (id, store_id, table_number, qr_code_url, capacity, is_active) VALUES
(1,  1, 'A1', '/qr/zus-klcc/A1', 2, TRUE),
(2,  1, 'A2', '/qr/zus-klcc/A2', 2, TRUE),
(3,  1, 'A3', '/qr/zus-klcc/A3', 4, TRUE),
(4,  1, 'B1', '/qr/zus-klcc/B1', 4, TRUE),
(5,  1, 'B2', '/qr/zus-klcc/B2', 6, TRUE),
(6,  1, 'B3', '/qr/zus-klcc/B3', 6, TRUE),
(7,  1, 'C1', '/qr/zus-klcc/C1', 8, TRUE),
(8,  1, 'C2', '/qr/zus-klcc/C2', 8, TRUE),
(9,  1, 'C3', '/qr/zus-klcc/C3', 10, TRUE),
(10, 1, 'P1', '/qr/zus-klcc/P1', 2, TRUE),
(11, 2, 'A1', '/qr/klcc-park/A1', 2, TRUE),
(12, 2, 'A2', '/qr/klcc-park/A2', 2, TRUE),
(13, 2, 'A3', '/qr/klcc-park/A3', 4, TRUE),
(14, 2, 'B1', '/qr/klcc-park/B1', 4, TRUE),
(15, 2, 'B2', '/qr/klcc-park/B2', 6, TRUE),
(16, 2, 'B3', '/qr/klcc-park/B3', 6, TRUE),
(17, 2, 'C1', '/qr/klcc-park/C1', 8, TRUE),
(18, 2, 'C2', '/qr/klcc-park/C2', 10, TRUE),
(19, 2, 'P1', '/qr/klcc-park/P1', 2, TRUE),
(20, 2, 'P2', '/qr/klcc-park/P2', 2, TRUE);

SELECT setval('store_tables_id_seq', 20);
...
SELECT setval('menu_categories_id_seq', 4);
...
SELECT setval('menu_items_id_seq', 19);
...
(2,  1, -22.80, 'payment', 'Payment for order #ORD-20260301',                   NOW() - interval '50 days', 2),
(3,  1, 22.80,  'refund',  'Refund for cancelled order #ORD-20260301',          NOW() - interval '49 days', 2),
(4,  2, 150.00, 'topup',   'Wallet top-up via credit card',                     NOW() - interval '50 days', 3),
(5,  2, -25.70, 'payment', 'Payment for order #ORD-20260315',                   NOW() - interval '35 days', 3),
(6,  2, -18.90, 'payment', 'Payment for order #ORD-20260320',                   NOW() - interval '28 days', 3),
(7,  3, 100.00, 'topup',   'Wallet top-up via FPX',                             NOW() - interval '45 days', 4),
(8,  3, -33.70, 'payment', 'Payment for order #ORD-20260401',                   NOW() - interval '12 days', 4),
(9,  4, 250.00, 'topup',   'Wallet top-up via credit card',                     NOW() - interval '40 days', 5),
(10, 4, -45.60, 'payment', 'Payment for order #ORD-20260405',                   NOW() - interval '8 days',  5),
(11, 5, 25.00,  'topup',   'Wallet top-up via TnG',                             NOW() - interval '25 days', 6),
(12, 5, -10.00, 'payment', 'Payment for order #ORD-20260410',                   NOW() - interval '3 days',  6);
...
(9,  6, 2, 11,   'ORD-20260401009', 'dine_in',  '[{"name":"Cappuccino","qty":1,"price":10.90},{"name":"Kaya Toast","qty":1,"price":7.90}]'::json,                                       18.80, 0.00,  0.00,    18.80, 'completed',   NULL,                              NULL,                                       'cash',        'paid',      18,  NULL,                                          NOW() - interval '12 days', NOW() - interval '11 days'),
...
(20, 6, 2, 13,   'ORD-20260413020', 'dine_in',  '[{"name":"Matcha Latte","qty":1,"price":12.90},{"name":"Kaya Toast","qty":2,"price":7.90}]'::json,                                    28.70, 0.00,  0.00,    28.70, 'preparing',   NULL,                              NULL,                                       'cash',        'paid',      28,  NULL,                                          NOW() - interval '45 minutes', NOW() - interval '30 minutes'),
...
(9,  2,  'Cappuccino',       1, 10.90, '{"size":"Regular","milk":"Whole Milk"}'::json,            10.90),
(9,  12, 'Kaya Toast',       1,  7.90, NULL,                                                      7.90),
...
(15, 7,  'Teh Tarik',        1,  8.90, '{"size":"Regular","sugar":"Normal"}'::json,                8.90),
...
(20, 8,  'Matcha Latte',     1, 12.90, '{"size":"Regular","milk":"Whole Milk","sweetness":"50%"}'::json, 12.90),
(20, 12, 'Kaya Toast',       2,  7.90, NULL,                                                     15.80),
...
(9,  9,  'cash',   18.80, 'completed', 'TXN-001009', NOW() - interval '12 days'),
...
(20, 20, 'cash',   28.70, 'completed', 'TXN-001020', NOW() - interval '45 minutes'),
...
(9,  6, 9,  2, 18, 'earn',   NOW() - interval '11 days', 'Points earned from order ORD-20260401009'),
...
(17, 5, NULL, 1, 100,'redeem', NOW() - interval '15 days', 'Redeemed for free Caramel Latte reward'),
...
SELECT setval('loyalty_transactions_id_seq', 20);

INSERT INTO rewards (id, name, description, points_cost, reward_type, item_id, discount_value, image_url, stock_limit, total_redeemed, is_active, created_at, updated_at) VALUES
(1, 'Free Cappuccino',       'Enjoy a free Regular Cappuccino on us',               150,  'free_item',         2,   NULL,  '/images/rewards/free-cappuccino.jpg',   500, 23,  TRUE, NOW() - interval '60 days', NOW()),
(2, 'RM10 Off Voucher',      'Get RM10 off your next order',                        200,  'discount_voucher',  NULL, 10.00, '/images/rewards/rm10-off.jpg',          NULL, 45, TRUE, NOW() - interval '60 days', NOW()),
(3, 'Free Kaya Toast',       'Classic Malaysian breakfast on the house',            80,   'free_item',         12,  NULL,  '/images/rewards/free-kaya-toast.jpg',   300, 18,  TRUE, NOW() - interval '55 days', NOW()),
(4, 'Free Affogato',         'Premium espresso dessert reward',                     250,  'free_item',         15,  NULL,  '/images/rewards/free-affogato.jpg',     100, 7,   TRUE, NOW() - interval '50 days', NOW());

SELECT setval('rewards_id_seq', 4);

INSERT INTO user_rewards (id, user_id, reward_id, store_id, redeemed_at, order_id, is_used) VALUES
(1, 5, 1, 1, NOW() - interval '15 days', NULL, FALSE),
(2, 4, 2, 1, NOW() - interval '10 days', NULL, FALSE),
(3, 3, 4, 1, NOW() - interval '7 days',  NULL, FALSE),
(4, 5, 3, 1, NOW() - interval '20 days', 8,   TRUE),
(5, 2, 3, 1, NOW() - interval '5 days',  NULL, FALSE);
...
(2, 3, 1, 1, NOW() - interval '50 days', NULL),
(3, 4, 2, 1, NOW() - interval '40 days', NULL),
(4, 5, 1, 1, NOW() - interval '38 days', NULL),
(5, 5, 4, 1, NOW() - interval '12 days', 13),
(6, 6, 1, 2, NOW() - interval '25 days', NULL),
(7, 3, 3, 1, NOW() - interval '10 days', NULL);
...
(2, NULL, 1, 'Priya Nair',  'priya@zus.my',  '+60123456222', 'barista', TRUE, '5678', NOW() - interval '70 days', NOW()),
...
SELECT setval('staff_shifts_id_seq', 8);
...
SELECT setval('feedback_id_seq', 11);
...
SELECT setval('audit_log_id_seq', 8);
...
INSERT INTO promo_banners (id, title, subtitle, image_url, target_url, position, store_id, start_date, end_date, is_active, created_at, updated_at) VALUES
(1, 'Ramadan Kareem',       '20% off all beverages',     '/images/promos/ramadan-banner.jpg',  '/promo/zus20',       1, 1, NOW() - interval '15 days', NOW() + interval '15 days', TRUE, NOW() - interval '15 days', NOW()),
(2, 'New Store Opening',    'KLCC Park is NOW OPEN!',    '/images/promos/klcc-park-banner.jpg','/stores/klcc-park',  2, 2, NOW() - interval '75 days', NOW() + interval '30 days', TRUE, NOW() - interval '75 days', NOW()),
(3, 'Happy Hour 2-4PM',     'Buy 1 Free 1 all lattes',   '/images/promos/happy-hour.jpg',      '/promo/happy-hour',  3, 1, NOW() - interval '5 days',  NOW() + interval '25 days', TRUE, NOW() - interval '5 days',  NOW());
...
(18, 2, 'Sugar Syrup',              8.00,   'litre', 2.00,   4.50,   NOW()),
(19, 2, 'Cups (Regular)',           400.00, 'pcs',   100.00, 0.15,   NOW()),
(20, 2, 'Lids',                     600.00, 'pcs',   100.00, 0.10,   NOW());

SELECT setval('inventory_items_id_seq', 20);
...
SELECT setval('favorites_id_seq', 10);
