...
class Store(Base):
    ...
    categories: Mapped[List[MenuCategory]] = relationship("MenuCategory", back_populates="store", cascade="all, delete-orphan")
    items: Mapped[List[MenuItem]] = relationship("MenuItem", back_populates="store", cascade="all, delete-orphan")
