...
export default function BundlePickerSheet({ bundle, onClose, onDone }: BundlePickerSheetProps) {
        ...
        >
          ...
          <div className="bps-header">
            <div className="bps-header-text">
              ...
              <p className="bps-subtitle">{t('menu.pickXSubtitle', { count: pickCount })}</p>
            </div>
          ...
          <div className="bps-counter">
            {t('menu.pickXSelected', { selected: totalSelected, count: pickCount })}
          </div>

          {!allowDuplicates && selectedIds.size >= pickCount && (
            <p style={{ textAlign: 'center', fontSize: 12, color: 'var(--color-warning)', margin: '0 0 8px' }}>
              ...
              {poolItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {allowDuplicates && (
                      <div className="bps-qty-controls" onClick={(e) => e.stopPropagation()}>
                        <button
          ...
          <div className="bps-footer">
            ...
            <button
              className={`bps-add-btn ${canAdd ? '' : 'bps-add-btn-disabled'}`}
              disabled={!canAdd}
              onClick={handleAddToCart}
            >
              {canAdd ? t('menu.pickXAddToCart') : t('menu.pickXMinRequired', { count: pickCount })}
            </button>
          </div>
        </motion.div>
      </motion.div>
