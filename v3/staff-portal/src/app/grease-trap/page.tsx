    ...
    <div style={{ padding: 24 }}>
      ...
      <div style={{ maxWidth: 600 }}>
        <div className="card" style={{ padding: 20, marginBottom: 16 }}>
          ...
          <textarea value={desc} onChange={e => setDesc(e.target.value)} placeholder="Any notes about the grease trap cleaning..." rows={3} style={{ width: "100%", padding: "10px 12px", borderRadius: "var(--radius-md)", border: "1px solid var(--color-border-light)", fontSize: 14, resize: "vertical", fontFamily: "inherit" }} maxLength={500} />
        </div>
        <div className="card" style={{ padding: 20, marginBottom: 16 }}>
