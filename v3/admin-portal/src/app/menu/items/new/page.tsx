...
export default function NewItemPage() {
  ...
  const [form, setForm] = useState<Record<string,any>>({ item_name:"", item_code:"", base_price:"", description:"", long_description:"", category_id:"", tax_category_id:"", allergen_ids:[] as number[], dietary_tag_ids:[] as number[], is_available:true, is_featured:false, modifier_groups:[] as any[] });
