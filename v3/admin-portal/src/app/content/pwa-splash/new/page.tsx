...
export default function SplashScreenNewPage() {
  ...
  const [form, setForm] = useState({ screen_name:"", title:"", subtitle:"", image_url:"", cta_text:"", cta_url:"", show_frequency:"once_per_session", dismissible:true, duration_ms:"", active_from:"", active_until:"", is_active:true });
    ...
    <div style={{padding:32}}>
      ...
      <div className="card" style={{padding:24,maxWidth:700}}>
        <form onSubmit={handleSubmit}><div className="df-grid">
          ...
          <div className="df-field"><label className="df-label">Duration (ms)</label><input type="number" value={form.duration_ms} onChange={e=>setForm({...form,duration_ms:e.target.value})} placeholder="3000" min={500} step={100}/><div className="df-hint">How long to show (default: 3000ms)</div></div>
