...
export default function StockEditPage() {
  ...
  useEffect(() => {
    api.getRaw<StockRecord>(`/admin/inventory/stocks/${id}`)
      .then((d: any) => {
      ...
      .catch((e: any) => setError(e.message || "Failed to load stock record"))
  ...
  if (!loading && !record) {
    return (
      <div style={{ padding: 32 }}>
        ...
        <button type="button" onClick={() => router.back()} className="btn btn-outline" style={{ marginTop: 12 }}>
    ...
    <div style={{ padding: 32 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
        ...
        <div>
          ...
          <p className="page-subtitle" style={{ marginTop: 2 }}>
            Store #{record?.store_id} | Item #{record?.inventory_item_id}
      ...
      <div className="card" style={{ padding: 24, maxWidth: 720 }}>
        <div className="df-grid">
          ...
          <div className="df-field">
            <label className="form-label">Reserved Stock</label>
            <input
              type="number"
              step="0.01"
              value={form.reserved_stock}
              onChange={e => setForm(f => ({ ...f, reserved_stock: Number(e.target.value) }))}
            />
          </div>
          <div className="df-field">
          ...
          <div className="df-field">
            ...
            <input
              ...
              onChange={e => setForm(f => ({ ...f, par_level: Number(e.target.value) }))}
            />
          </div>
          <div className="df-field" style={{ gridColumn: "1/-1" }}>
            ...
            <input
              ...
              placeholder="e.g. Shelf A-3, Cold Room"
            />
          </div>
        </div>
